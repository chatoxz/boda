...
?>
<div class="<?= Inflector::camel2id($baseModelClass) ?>-index" id="id_gridview">
    ...
    <p>
        <?= "<?= " ?>Html::a(<?= $generator->generateString('Create')?>.' '.<?= $generator->generateString(Inflector::camel2words($baseModelClass)) ?>, ['create'], ['class' => 'btn btn-success add-modal-data', 'title' => <?= $generator->generateString('Create') ?>.' '. <?= $generator->generateString(Inflector::camel2words($baseModelClass)) ?> ]) ?>
        <?php if (!empty($generator->searchModelClass)): ?>
